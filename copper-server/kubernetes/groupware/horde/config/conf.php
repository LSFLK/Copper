...
$conf['secret_key'] = 'hKecrxFVBPgfeO4MYxgEbao';
$conf['umask'] = 077;
...
$conf['sql']['password'] = 'c0pperDB';
$conf['sql']['hostspec'] = 'mysql';
$conf['sql']['port'] = 3306;
...
$conf['mailer']['params']['host'] = 'email';
$conf['mailer']['params']['port'] = 587;
$conf['mailer']['params']['secure'] = 'tls';
$conf['mailer']['params']['localhost'] = 'copper.opensource.lk';
...
$conf['imap']['server'] = 'email';
$conf['imap']['port'] = 143;
$conf['imap']['secure'] = 'tls';
$conf['imap']['maildomain'] = 'copper.opensource.lk';
...
$conf['max_exec_time'] = 0;
$conf['compress_pages'] = true;
$conf['secret_key'] = 'BhstrRNmlrh8PJ2x_x8xBXC';
$conf['umask'] = 077;
$conf['testdisable'] = false;
$conf['use_ssl'] = 2;
